...
public class Counter3 extends JFrame implements ActionListener ,  ItemListener
{
	...
	public Counter3 ()
	{
		...
		lblNewLabel = new JLabel("Counter 3");
	 ...
	 public void actionPerformed(ActionEvent e) {
    	...
    	//create an ArrayList object to contain objects of ItemInformation class
 	    ...
 	    FastCounter.add(2);
 	    LongCounter.add(3);
    	 Queue < CustomerInformation > qCounter1 = new < ItemInformation > LinkedList();
  	    Queue < CustomerInformation > qCounter2 = new < ItemInformation > LinkedList();
  	    Queue < CustomerInformation > qCounter3 = new < ItemInformation > LinkedList();
  	 
  	    //Use BufferedReader to get Data from file
